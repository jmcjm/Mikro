...
void main() {
  ...
  group('formatPlaybackRate', () {
    test('Polish decimal separator is a comma', () {
    ...
    test('English decimal separator is a dot', () {
    ...
    test('always one digit after separator, at most two', () {
      // Without minimum "1,0" would collapse to "1", making pill jump in width on every
      // switch; without maximum 1,25 would sprawl into digits nobody needs.
